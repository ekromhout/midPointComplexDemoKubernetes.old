...
kubectl create secret generic mp-sp-signing-key.pem --from-file configs-and-secrets/midpoint/shibboleth/sp-signing-key.pem 
kubectl create secret generic mp-sp-encrypt-key.pem --from-file configs-and-secrets/midpoint/shibboleth/sp-encrypt-key.pem 
